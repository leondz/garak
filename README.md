...
* You can test the new code in at least two ways:
  ...
  * Run a scan with test plugins
    ...
    * For detectors, try a blank generator and a blank probe: `python3 -m garak -m test.Blank -p blank.BlankPrompt -d mymodule`
    * For generators, try a blank probe and always.Pass detector: `python3 -m garak -m mymodule -p blank.BlankPrompt -d always.Pass`
