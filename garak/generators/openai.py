...
class OpenAIGenerator(Generator):
    def __init__(self, name, model_type="completion", generations=10):
        ...
        self.stop=["#", ";"]
        print(f'loading {Style.RESET_ALL}{Fore.LIGHTMAGENTA_EX}generator{Style.RESET_ALL}: OpenAI:{name}')
        ...
        if model_type == "completion":
            ...
            raise ValueError(f"No support yet for requested {model_type} OpenAI model type")
