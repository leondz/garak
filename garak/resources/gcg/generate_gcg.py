...
gcg_parser.add_argument("--transfer", action="store_true", help="Whether to generate attack for transfer")
...
gcg_parser.add_argument("--train_data", type=str, default=f"{PATH}/data/advbench/harmful_behaviors.csv",
                        help="Path to training data")
gcg_parser.add_argument("--n_train", type=int, default=50, help="Number of training samples to use")
gcg_parser.add_argument("--n_test", type=int, default=0, help="Number of test samples to use")
...
gcg_parser.add_argument("--save_logs", action="store_true", help="Keep detailed GCG generation logs")
...
def generate_gcg(model_names: list[str], transfer: bool = False, progressive: bool = False, stop_success: bool = True,
                 ...
                 n_steps: int = 500, batch_size: int = 128, topk: int = 256, temp: int = 1, target_weight: float = 1.0,
